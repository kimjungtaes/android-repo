...
import com.example.binderservicemessengerpro.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //1.바인딩 서비스를 진행하기 위해서는 service커넥션을 만든다
        serviceConnection = object : ServiceConnection{
            //BindService 요청했을때 연결이 되면 callback이 진행되고 service에 제공한 IBinder를 매개변수로 가져온다.

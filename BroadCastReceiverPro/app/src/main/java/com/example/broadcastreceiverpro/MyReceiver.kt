...
class MyReceiver : BroadcastReceiver() {
    ...
    override fun onReceive(context: Context, intent: Intent) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            ...
            //채널에 대한 정보등록
            channel.description + "My kjt Description"
        ...
        builder.setContentTitle("Bettery Infomation")
        builder.setContentText("Bettery Percent ${intent.getStringExtra("batteryPercent")}")
